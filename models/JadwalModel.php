...
class JadwalModel
{
    ...
    private $source_table = "jadwal_kuliah";
    ...
    public function deleteJadwal($id)
    {
        try {
            ...
            $query = "DELETE FROM " . $this->source_table . " WHERE id_jadwal = :id";
            $stmt = $this->conn->prepare($query);
    ...
    public function createJadwal($data)
    {
        try {
            ...
            $query = "INSERT INTO " . $this->source_table . " 
                      (id_mk, id_dosen, id_kelas, hari, jam_mulai, jam_selesai, ruangan, tahun_akademik) 
    ...
    public function updateJadwal($id, $data)
    {
        try {
            ...
            $query = "UPDATE " . $this->source_table . " SET 
                        id_mk = :id_mk, 
                        id_dosen = :id_dosen, 
                        id_kelas = :id_kelas, 
                        hari = :hari, 
